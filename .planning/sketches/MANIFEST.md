...
| 003 | confirmation-email-cta | What does the durable re-entry CTA inside the confirmation email look like (table/inline-CSS, no JS)? | **B — "keep this email, it's your key" accent callout** | email, entry |
